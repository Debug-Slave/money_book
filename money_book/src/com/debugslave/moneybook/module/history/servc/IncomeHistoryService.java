...
import com.debugslave.moneybook.module.history.dao.IncomeDao;

@Service("incomeService")
public class IncomeHistoryService implements HistoryService {
	...
	public ResultData insertHistory(HistoryVO history) throws Exception {
		...
		int insertRow = incomeDao.insertIncomeHistory(history);
	...
	public ResultData deleteHistory(HistoryVO history) throws Exception {
		...
		int insertRow = incomeDao.deleteIncomeHistory(history);
	...
	public List<HashMap<String, String>> selectHistoryList(int userIdx, Date startDate, Date endDate) throws Exception {
		...
		return incomeDao.selectIncomeHistory(paramMap);
	}

	@Override
	public HistoryVO selectOneHistory(HistoryVO searchVO) throws Exception {
		return incomeDao.selectIncomeHistoryInfo(searchVO);
	}
